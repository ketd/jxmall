...
public interface MemberSocialOpenFeignApi {
    ...
    @GetMapping(value = "/member/MemberSocial/info/socialUid")
    public Result<MemberSocialTO> getInfoBySocialUid(@RequestParam("socialUid") String socialUid,@RequestParam("type") Integer Type);
    /**
     * 新增单点登录用户信息关联
     */
