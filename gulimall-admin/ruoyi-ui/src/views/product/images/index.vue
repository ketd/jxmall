  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  ...
                  <el-form-item label="图片地址" prop="imgUrl">
                    <el-input
                        v-model="queryParams.data.imgUrl"
                        placeholder="请输入图片地址"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="默认图[0 - 不是默认图，1 - 是默认图]" prop="defaultImg">
                    <el-input
                        v-model="queryParams.data.defaultImg"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listImagesPage(this.queryParams).then(response => {
          this.imagesList = response.data.rows;
