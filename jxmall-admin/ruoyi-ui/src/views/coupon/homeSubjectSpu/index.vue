...
<script>
  import {
      listHomeSubjectSpuPage,
    getHomeSubjectSpu,
    delHomeSubjectSpu,
    addHomeSubjectSpu,
    updateHomeSubjectSpu ,
    exportHomeSubjectSpu
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listHomeSubjectSpuPage(this.queryParams).then(response => {
          this.homeSubjectSpuList = response.data.rows;
  ...
  handleExport(row)
  {
    ...
    return exportHomeSubjectSpu(ids);
    }).then(() => {
