  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  ...
                  <el-form-item label="快速展示【是否展示在介绍上；0-否 1-是】" prop="quickShow">
                    <el-input
                        v-model="queryParams.data.quickShow"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listValuePage(this.queryParams).then(response => {
          this.valueList = response.data.rows;
