    ...
    <el-table v-loading="loading" :data="brandList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="品牌logo" align="center" prop="logo" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.logo" :width="100" :height="50" alt="Image" />
        </template>
      </el-table-column>
...
<script>
import {addBrand, delBrand, exportBrand, getBrand, getBrandUrl, listBrandPage, updateBrand} from "@/api/product/brand";
