  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  ...
                  <el-form-item label="支付宝交易流水号" prop="alipayTradeNo">
                    <el-input
                        v-model="queryParams.data.alipayTradeNo"
                  ...
                  <el-form-item label="支付总金额" prop="totalAmount">
                    <el-input
                        v-model="queryParams.data.totalAmount"
                  ...
                  <el-form-item label="交易内容" prop="subject">
                    <el-input
                        v-model="queryParams.data.subject"
                        placeholder="请输入交易内容"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="确认时间" prop="confirmTime">
                    <el-date-picker clearable
                                    v-model="queryParams.data.confirmTime"
                                    type="date"
                  ...
                  <el-form-item label="回调时间" prop="callbackTime">
                    <el-date-picker clearable
                                    v-model="queryParams.data.callbackTime"
                                    type="date"
                                    value-format="yyyy-MM-dd HH:mm:ss"
                                    placeholder="请选择回调时间">
                    </el-date-picker>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listPaymentInfoPage(this.queryParams).then(response => {
          this.paymentInfoList = response.data.rows;
