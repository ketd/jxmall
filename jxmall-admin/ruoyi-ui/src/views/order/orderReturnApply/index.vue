  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  ...
                  <el-form-item label="会员用户名" prop="memberUsername">
                    <el-input
                        v-model="queryParams.data.memberUsername"
                  ...
                  <el-form-item label="退款金额" prop="returnAmount">
                    <el-input
                        v-model="queryParams.data.returnAmount"
                        placeholder="请输入退款金额"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="退货人姓名" prop="returnName">
                    <el-input
                        v-model="queryParams.data.returnName"
                  ...
                  <el-form-item label="退货人电话" prop="returnPhone">
                    <el-input
                        v-model="queryParams.data.returnPhone"
                  ...
                  <el-form-item label="申请状态[0-&gt;待处理；1-&gt;退货中；2-&gt;已完成；3-&gt;已拒绝]" prop="status">
                    <el-select v-model="queryParams.data.status" placeholder="请选择申请状态[0-&gt;待处理；1-&gt;退货中；2-&gt;已完成；3-&gt;已拒绝]" clearable>
                      <el-option
                  ...
                  <el-form-item label="处理时间" prop="handleTime">
                    <el-date-picker clearable
                                    v-model="queryParams.data.handleTime"
                                    type="date"
                  ...
                  <el-form-item label="商品品牌" prop="skuBrand">
                    <el-input
                        v-model="queryParams.data.skuBrand"
                        placeholder="请输入商品品牌"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="退货数量" prop="skuCount">
                    <el-input
                        v-model="queryParams.data.skuCount"
                        placeholder="请输入退货数量"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="商品实际支付单价" prop="skuRealPrice">
                    <el-input
                        v-model="queryParams.data.skuRealPrice"
                  ...
                  <el-form-item label="处理人员" prop="handleMan">
                    <el-input
                        v-model="queryParams.data.handleMan"
                        placeholder="请输入处理人员"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="收货人" prop="receiveMan">
                    <el-input
                        v-model="queryParams.data.receiveMan"
                        placeholder="请输入收货人"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="收货时间" prop="receiveTime">
                    <el-date-picker clearable
                                    v-model="queryParams.data.receiveTime"
                                    type="date"
                                    value-format="yyyy-MM-dd HH:mm:ss"
                                    placeholder="请选择收货时间">
                    </el-date-picker>
                  ...
                  <el-form-item label="收货电话" prop="receivePhone">
                    <el-input
                        v-model="queryParams.data.receivePhone"
                        placeholder="请输入收货电话"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
...
<script>
  import {
      listOrderReturnApplyPage,
    getOrderReturnApply,
    delOrderReturnApply,
    addOrderReturnApply,
    updateOrderReturnApply ,
    exportOrderReturnApply
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listOrderReturnApplyPage(this.queryParams).then(response => {
          this.orderReturnApplyList = response.data.rows;
  ...
  handleExport(row)
  {
    ...
    return exportOrderReturnApply(ids);
    }).then(() => {
