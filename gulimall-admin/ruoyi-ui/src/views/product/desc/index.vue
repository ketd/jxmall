    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['product:desc:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['product:desc:export']"
        >导出</el-button>
      </el-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listDescPage(this.queryParams).then(response => {
          this.descList = response.data.rows;
