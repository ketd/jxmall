...
<script>
  import {
      listCouponSpuRelationPage,
    getCouponSpuRelation,
    delCouponSpuRelation,
    addCouponSpuRelation,
    updateCouponSpuRelation ,
    exportCouponSpuRelation
  } from "@/api/coupon/couponSpuRelation";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listCouponSpuRelationPage(this.queryParams).then(response => {
          this.couponSpuRelationList = response.data.rows;
  ...
  handleExport(row)
  {
    ...
    return exportCouponSpuRelation(ids);
    }).then(() => {
