  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  <el-form-item label="秒杀订单超时关闭时间(分)" prop="flashOrderOvertime">
                    <el-input
                        v-model="queryParams.data.flashOrderOvertime"
                  ...
                  <el-form-item label="正常订单超时时间(分)" prop="normalOrderOvertime">
                    <el-input
                        v-model="queryParams.data.normalOrderOvertime"
                  ...
                  <el-form-item label="发货后自动确认收货时间" prop="confirmOvertime">
                    <el-input
                        v-model="queryParams.data.confirmOvertime"
                  ...
                  <el-form-item label="自动完成交易时间，不能申请退货" prop="finishOvertime">
                    <el-input
                        v-model="queryParams.data.finishOvertime"
                  ...
                  <el-form-item label="订单完成后自动好评时间" prop="commentOvertime">
                    <el-input
                        v-model="queryParams.data.commentOvertime"
...
<script>
  import {
      listOrderSettingPage,
    getOrderSetting,
    delOrderSetting,
    addOrderSetting,
    updateOrderSetting ,
    exportOrderSetting
  } from "@/api/order/orderSetting";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listOrderSettingPage(this.queryParams).then(response => {
          this.orderSettingList = response.data.rows;
