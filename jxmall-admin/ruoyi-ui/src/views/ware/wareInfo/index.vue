  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  ...
                  <el-form-item label="仓库地址" prop="address">
                    <el-input
                        v-model="queryParams.data.address"
                        placeholder="请输入仓库地址"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listWareInfoPage(this.queryParams).then(response => {
          this.wareInfoList = response.data.rows;
