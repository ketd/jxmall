  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  ...
                  <el-form-item label="属性值" prop="attrValue">
                    <el-input
                        v-model="queryParams.data.attrValue"
                        placeholder="请输入属性值"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="快速展示" prop="quickShow">
                    <el-select v-model="queryParams.data.quickShow" placeholder="请选择快速展示" clearable>
                      <el-option
                          v-for="dict in dict.type.quick_show"
                          :key="dict.value"
                          :label="dict.label"
                          :value="dict.value"
                      />
      ...
      <el-table-column type="selection" width="55" align="center" />
              ...
              <el-table-column label="快速展示" align="center" prop="quickShow">
                <template slot-scope="scope">
                      <dict-tag :options="dict.type.quick_show" :value="scope.row.quickShow"/>
                </template>
              </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listSpuValuePage(this.queryParams).then(response => {
          this.spuValueList = response.data.rows;
