  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  <el-form-item label="退款的订单" prop="orderReturnId">
                    <el-input
                        v-model="queryParams.data.orderReturnId"
                  ...
                  <el-form-item label="退款金额" prop="refund">
                    <el-input
                        v-model="queryParams.data.refund"
                        placeholder="请输入退款金额"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="退款交易流水号" prop="refundSn">
                    <el-input
                        v-model="queryParams.data.refundSn"
                  ...
                  <el-form-item label="退款渠道[1-支付宝，2-微信，3-银联，4-汇款]" prop="refundChannel">
                    <el-input
                        v-model="queryParams.data.refundChannel"
      ...
      <el-table-column type="selection" width="55" align="center" />
              ...
              <el-table-column label="退款渠道[1-支付宝，2-微信，3-银联，4-汇款]" align="center" prop="refundChannel">
                <template slot-scope="scope">
                      <dict-tag :options="dict.type.refund_channel" :value="scope.row.refundChannel"/>
                </template>
              </el-table-column>
              <el-table-column label="退款内容" align="center" prop="refundContent" />
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listRefundInfoPage(this.queryParams).then(response => {
          this.refundInfoList = response.data.rows;
