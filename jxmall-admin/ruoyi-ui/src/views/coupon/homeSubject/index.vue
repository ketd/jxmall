  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  ...
                  <el-form-item label="专题副标题" prop="subTitle">
                    <el-input
                        v-model="queryParams.data.subTitle"
                  ...
                  <el-form-item label="显示状态" prop="status">
                    <el-select v-model="queryParams.data.status" placeholder="请选择显示状态" clearable>
                      <el-option
      ...
      <el-table-column type="selection" width="55" align="center" />
              ...
              <el-table-column label="显示状态" align="center" prop="status">
                <template slot-scope="scope">
                      <dict-tag :options="dict.type.show_status" :value="scope.row.status"/>
                </template>
              </el-table-column>
              <el-table-column label="详情连接" align="center" prop="url" />
              <el-table-column label="排序" align="center" prop="sort" />
              <el-table-column label="专题图片地址" align="center" prop="img" width="100">
                <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                        ...
                        <el-form-item label="显示状态" prop="status">
                          <el-select v-model="form.status" placeholder="请选择显示状态">
                            <el-option
                                v-for="dict in dict.type.show_status"
                                :key="dict.value"
                                :label="dict.label"
                        ...
                        <el-form-item label="专题图片地址" prop="img">
                          <image-upload v-model="form.img" @upload-success="handleUploadSuccess"/>
                        </el-form-item>
      </el-form>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listHomeSubjectPage(this.queryParams).then(response => {
          this.homeSubjectList = response.data.rows;
