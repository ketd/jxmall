  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  ...
                  <el-form-item label="创建人" prop="userId">
                    <el-input
                        v-model="queryParams.data.userId"
                        placeholder="请输入创建人"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
...
<script>
  import {
      listSeckillPromotionPage,
    getSeckillPromotion,
    delSeckillPromotion,
    addSeckillPromotion,
    updateSeckillPromotion ,
    exportSeckillPromotion
  } from "@/api/coupon/seckillPromotion";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listSeckillPromotionPage(this.queryParams).then(response => {
          this.seckillPromotionList = response.data.rows;
  ...
  handleExport(row)
  {
    ...
    return exportSeckillPromotion(ids);
    }).then(() => {
