  ...
  <div class="app-container">
    <el-form :model="queryParams.data" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                  <el-form-item label="活动id" prop="promotionId">
                    <el-input
                        v-model="queryParams.data.promotionId"
                        placeholder="请输入活动id"
                        clearable
                  ...
                  <el-form-item label="活动场次id" prop="promotionSessionId">
                    <el-input
                        v-model="queryParams.data.promotionSessionId"
                  ...
                  <el-form-item label="秒杀价格" prop="seckillPrice">
                    <el-input
                        v-model="queryParams.data.seckillPrice"
                        placeholder="请输入秒杀价格"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="秒杀总量" prop="seckillCount">
                    <el-input
                        v-model="queryParams.data.seckillCount"
                        placeholder="请输入秒杀总量"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
                  ...
                  <el-form-item label="每人限购数量" prop="seckillLimit">
                    <el-input
                        v-model="queryParams.data.seckillLimit"
                  ...
                  <el-form-item label="排序" prop="seckillSort">
                    <el-input
                        v-model="queryParams.data.seckillSort"
                        placeholder="请输入排序"
                        clearable
                        @keyup.enter.native="handleQuery"
                    />
...
<script>
  import {
      listSeckillSkuRelationPage,
    getSeckillSkuRelation,
    delSeckillSkuRelation,
    addSeckillSkuRelation,
    updateSeckillSkuRelation ,
    exportSeckillSkuRelation
  } from "@/api/coupon/seckillSkuRelation";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listSeckillSkuRelationPage(this.queryParams).then(response => {
          this.seckillSkuRelationList = response.data.rows;
  ...
  handleExport(row)
  {
    ...
    return exportSeckillSkuRelation(ids);
    }).then(() => {
